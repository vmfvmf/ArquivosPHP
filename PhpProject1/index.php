...
<h1>Carregador de Arquivos</h1>

<blockquote>
    <p>Existem 2 jeitos de selecionar  arquivos:</p>
    <ol>
        <li>Arraste e solte os arquivos na pagina.</li>
        <li>Clique em adicionar arquivos.</li>
    </ol>
    <p>Entao inicie os uploads.</p>
</blockquote>
...
<form id="fileupload" action="UploadHandler.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="fileupload-buttonbar">
        <div class="fileupload-buttons">
            ...
            <button type="submit" class="start">Comecar upload</button>
